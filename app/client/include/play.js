const { canModifyQueue, STAY_TIME } = require('../../BackEnd/config/config');
const scdl = require('soundcloud-downloader');
const ytdl = require('erit-ytdl');

module.exports = {
  async play (song, message) {
    const { SOUNDCLOUD_CLIENT_ID } = require('../../BackEnd/config/config');
    let config;
    try {
    ...
    try {
      ...
      if (queue) {
        queue.songs.shift();
        module.exports.play(queue.songs[0], message).then();
      }
